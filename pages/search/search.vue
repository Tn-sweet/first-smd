					...
					<view class="search-hot">
						...
						<!-- <view class="search-hot-item">
							...
							<view class="search-hot-word">
								<view>少年 <image src="../../static/logo.png" mode="aspectFit"></image> </view>
								<view>少年 这个词实在是太美了</view>
							</view>
							<text class="search-hot-count">14534254</text>
						</view> -->
						<view class="search-hot-item" v-for="(item,index) in searchHot" :key="index" @tap="handleToWord(item.searchWord)">
							<view class="search-hot-top">{{ index + 1 }}</view>
							<view class="search-hot-word">
								<view>{{ item.searchWord }} <image :src="item.iconUrl" mode="aspectFit"></image> </view>
